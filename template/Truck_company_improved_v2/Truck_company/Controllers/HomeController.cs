...
public class HomeController : Controller
{
    ...
    {
        var siteSettings = await _context.SiteSettings.FirstOrDefaultAsync() ?? new SiteSettings();
        var hero = await _context.HeroSections.FirstOrDefaultAsync() ?? new HeroSection();
        var about = await _context.AboutSections.FirstOrDefaultAsync() ?? new AboutSection();
        var contact = await _context.ContactSettings.FirstOrDefaultAsync() ?? new ContactSettings();
